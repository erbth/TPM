...
\begin{document}
	...
	These options can be used to refine the results and the output of the query command \texttt{-{}-find-files}.
	...
	\begin{tabularx}{\textwidth}{lX}
		...
		\texttt{-{}-print-only-names} & Do only print the package's names and no version or architecture \\
	\end{tabularx}
	\egroup
